<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="微博标题" prop="weibobiaoti">
          <el-input v-model="ruleForm.weibobiaoti" 
              placeholder="微博标题" clearable  :readonly="ro.weibobiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="微博标题" prop="weibobiaoti">
              <el-input v-model="ruleForm.weibobiaoti" 
                placeholder="微博标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="昵称" prop="nicheng">
              <el-input v-model="ruleForm.nicheng" 
                placeholder="昵称" readonly></el-input>
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="微博内容" prop="weiboneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.weiboneirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.weiboneirong" label="微博内容" prop="weiboneirong">
                    <span v-html="ruleForm.weiboneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
            ...
            ruleForm: {
                	        weibobiaoti: '',
                                      ...
                                      leixingOptions: [],
                                                                                                                      rules: {
                  weibobiaoti: [
                            { required: true, message: '微博标题不能为空', trigger: 'blur' },
                                    	                                                              ],
                  leixing: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='weibobiaoti'){
            this.ruleForm.weibobiaoti = obj[o];
	    this.ro.weibobiaoti = true;
            continue;
          }
	            	            if(o=='leixing'){
	    ...
	    this.ro.tupian = true;
            continue;
	            	            ...
	            	            if(o=='weiboneirong'){
            this.ruleForm.weiboneirong = obj[o];
	    this.ro.weiboneirong = true;
            continue;
          }
	            	            if(o=='faburiqi'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                            ...
                                                            this.$http({
              url: `option/weiboleixing/leixing`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
	...
	this.ruleForm.weiboneirong = this.ruleForm.weiboneirong.replace(reg,'../../../ssmx4stk/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `weiboxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.weiboxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
